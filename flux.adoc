...
We just generated a `Flux`, and now we can do stuff with it. There are actually only two things you can do with it: operate on it (transform it, or combine it with other streams) or subscribe to it (it's a publisher).
